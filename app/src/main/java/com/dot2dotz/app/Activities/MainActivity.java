...
import com.dot2dotz.app.Fragments.Coupon;
import com.dot2dotz.app.Fragments.Help;
import com.dot2dotz.app.Fragments.HomeFragment;
import com.dot2dotz.app.Fragments.Payment;
import com.dot2dotz.app.Fragments.Wallet;
import com.dot2dotz.app.Fragments.YourTrips;
...
import com.dot2dotz.app.Utils.CustomTypefaceSpan;
import com.dot2dotz.app.Utils.MyTextView;
import com.dot2dotz.app.Retrofit.ResponseListener;
...
public class MainActivity extends AppCompatActivity implements HomeFragment.HomeFragmentListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            CommonUtils.setLanguage(MainActivity.this);
...
*/
    ...
    private void setUpNavigationView() {
        ...
        //Set Text to navigation Menu Items
        navigationView.getMenu().findItem(R.id.nav_payment).setTitle(R.string.action_payment);
        navigationView.getMenu().findItem(R.id.nav_yourtrips).setTitle(R.string.action_trips);
        navigationView.getMenu().findItem(R.id.nav_coupon).setTitle(R.string.action_coupon);
        navigationView.getMenu().findItem(R.id.nav_wallet).setTitle(R.string.action_wallet);
        navigationView.getMenu().findItem(R.id.passbook).setTitle(R.string.passbook);
        navigationView.getMenu().findItem(R.id.settings).setTitle(R.string.settings);
        navigationView.getMenu().findItem(R.id.nav_help).setTitle(R.string.action_help);
        navigationView.getMenu().findItem(R.id.nav_share).setTitle(R.string.action_share);
        navigationView.getMenu().findItem(R.id.nav_logout).setTitle(R.string.action_logout);
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.passbook:
                      ...
                      /*  navItemIndex = 2;
                        CURRENT_TAG = TAG_YOURTRIPS;*/
                        SharedHelper.putKey(context, "current_status", "");
                        Intent i = new Intent(MainActivity.this, WalletAndCouponHistory.class);
                        i.putExtra("tag", "past");
                        startActivity(i);
                        return true;
                    //break;
...
//                .requestIdToken("795253286119-p5b084skjnl7sll3s24ha310iotin5k4.apps.googleusercontent.com")
    ...
    public void logout() {
        final String language_code = SharedHelper.getKey(activity, "language");
        ...
        try {
            if (data != null) {
                if (HomeFragment.homeFragment != null)
                    (HomeFragment.homeFragment).postSumUpPayment(resultCode, data);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
